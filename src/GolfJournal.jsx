...
const ALL_ZONES = [...FAIRWAY_ZONES, ...FAIRWAY_BUNKER_ZONES, GREEN_ZONE, ...BUNKER_ZONES, ...MISS_ZONES];
...
function ShotZoneSelector({ value, onChange }) {
  ...
  const allGeom = [...fairwayGeom, ...fairwayBunkerGeom, greenGeom, ...bunkerGeom, ...missGeom];
